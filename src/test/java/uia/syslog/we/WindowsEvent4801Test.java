...
import uia.syslog.we.model.WindowsEvent4801;

public class WindowsEvent4801Test extends WindowsEventTest {

    @Test
    public void testObject() throws Exception {
        String content = "AUDIT_SUCCESS 已解除鎖定工作站。 " +
                "Subject: " +
        ...
        WindowsEvent4801 evt = parse2Object("4801", content, Locale.US);
        Assert.assertEquals("4801", evt.getEventId());
    ...
    public void testUS() throws Exception {
        ...
        Assert.assertNotNull(parse2Map("4801", content, Locale.US));
    }
    ...
    public void testTW() throws Exception {
        ...
        Assert.assertNotNull(parse2Map("4801", content, Locale.TAIWAN));
    }

    @Override
    protected void validate(Map<String, Object> result) {
        Assert.assertEquals(result.get("logHeader"), "AUDIT_SUCCESS 已解除鎖定工作站。");
