...
import uia.syslog.we.model.WindowsEvent4701;

public class WindowsEvent4701Test extends WindowsEventTest {
    ...
    public void testObject() throws Exception {
        ...
        WindowsEvent4701 evt = parse2Object("4701", content, Locale.US);
        Assert.assertEquals("4701", evt.getEventId());
    ...
    public void testUS() throws Exception {
        ...
        Assert.assertNotNull(parse2Map("4701", content, Locale.US));
    }
    ...
    public void testTW() throws Exception {
        ...
        Assert.assertNotNull(parse2Map("4701", content, Locale.TAIWAN));
    }
