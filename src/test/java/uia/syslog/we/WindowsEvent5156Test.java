...
import uia.syslog.we.model.WindowsEvent5156;

public class WindowsEvent5156Test extends WindowsEventTest {
    ...
    public void testObject() throws Exception {
        ...
        WindowsEvent5156 evt = parse2Object("5156", content, Locale.US);
        Assert.assertEquals("5156", evt.getEventId());
    ...
    public void testUS() throws Exception {
        ...
        Assert.assertNotNull(parse2Map("5156", content, Locale.US));
    }
