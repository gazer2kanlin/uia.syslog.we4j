...
import uia.syslog.we.model.WindowsEvent4700;

public class WindowsEvent4700Test extends WindowsEventTest {
    ...
    public void testObject() throws Exception {
        ...
        WindowsEvent4700 evt = parse2Object("4700", content, Locale.US);
        Assert.assertEquals("4700", evt.getEventId());
    ...
    public void testUS() throws Exception {
        ...
        Assert.assertNotNull(parse2Map("4700", content, Locale.US));
    }
    ...
    public void testTW() throws Exception {
        ...
        Assert.assertNotNull(parse2Map("4700", content, Locale.TAIWAN));
    }
