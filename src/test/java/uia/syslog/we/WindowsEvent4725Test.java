...
import uia.syslog.we.model.WindowsEvent4725;
...
public class WindowsEvent4725Test extends WindowsEventTest {
    ...
    public void testUS() throws Exception {
        ...
        Assert.assertNotNull(parse2Map("4725", content, Locale.US));
    }
    ...
    public void testTW() throws Exception {
        ...
        Assert.assertNotNull(parse2Map("4725", content, Locale.TAIWAN));
    }
