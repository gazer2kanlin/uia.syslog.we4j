...
public class WindowsEventSampleTest extends WindowsEventTest {
    ...
    public void testObject() throws Exception {
        ...
        try {
            parse2Object("-003", content, Locale.US);
            Assert.assertTrue(false);
        }
        catch (WindowsEventException ex) {
            Assert.assertEquals("uia.syslog.we.model.WindowsEvent-003 not found", ex.getMessage());
        }
    }
    ...
    public void test001() throws Exception {
        ...
        try {
            parse2Map("-001", content, Locale.US);
            Assert.assertTrue(false);
        }
        catch (WindowsEventException ex) {
    ...
    public void test002() throws Exception {
        ...
        try {
            parse2Map("-002", content, Locale.US);
            Assert.assertTrue(false);
        }
        catch (WindowsEventException ex) {
    ...
    public void test() throws Exception {
        ...
        for (int i = 0; i < data.length; i++) {
            ...
            Assert.assertTrue(parse2Map(id, content, Locale.TAIWAN).size() > 0);
        }
