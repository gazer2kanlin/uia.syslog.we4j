...
import uia.syslog.we.model.WindowsEvent4699;

public class WindowsEvent4699Test extends WindowsEventTest {
    ...
    public void testObject() throws Exception {
        ...
        WindowsEvent4699 evt = parse2Object("4699", content, Locale.US);
        Assert.assertEquals("4699", evt.getEventId());
    ...
    public void testUS() throws Exception {
        ...
        Assert.assertNotNull(parse2Map("4699", content, Locale.US));
    }
    ...
    public void testTW() throws Exception {
        ...
        Assert.assertNotNull(parse2Map("4699", content, Locale.TAIWAN));
    }
